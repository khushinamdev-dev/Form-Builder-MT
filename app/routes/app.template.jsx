...
const templatesData = [
  {
    ...
    description:
      "Captures basic customer details like name, email, phone, and address",
    category: "custom",
    path: "/app/contact",
      ...
      <s-section>
        <s-stack direction="inline" justifyContent="space-between">
          <s-stack>
            ...
            <s-stack gap="base">
              <s-text>
                Create fully custom forms or workflows from the ground up.
              </s-text>
            ...
            <s-section padding="none">
              <s-stack>
                ...
                <s-stack padding="base" gap="base">
                  ...
                  <s-button
                    onClick={() =>
                      navigate(`${template.path}?category=${template.category}`)
                    }
                  >
                    {template.buttonText}
                  </s-button>
