...
import { useNavigate, useSubmit, useActionData, useSearchParams } from "react-router";
...
export default function FormBuilder({ config, existingForm = null }) {
    ...
    const [pages, setPages] = useState(
        () => existingForm?.pages?.length ? existingForm.pages : [{ id: 1, title: "Page 1" }]
    );
        ...
        <s-page>
            ...
            <s-stack direction="inline" justifyContent="space-between" alignItems="center" padding="base">
                <s-stack direction="inline" alignItems="center" gap="base">
                    <s-button onClick={() => navigate(isEditing ? "/app/forms" : "/app/template")}>
                                    ...
                                    {selectedFieldId === null ? (
                                        ...
                                        <s-section padding="none" gap="none" >
                                            <s-stack padding="none" gap="base">
                                                <s-stack gap="base" style={{ paddingBottom: "16px", marginBottom: "8px", borderBottom: "1px solid #e5e7eb" }}>
                                                    ...
                                                    <s-text-field
                                                        ...
                                                        onInput={handleFieldInput}
                                                        onChange={(e) => setFormHeaderTitle(e.currentTarget.value)}
                                                        details="Header displayed at the top of the form"
                                                    />

                                                    <s-stack gap="small">
                                                        <s-text style={{ fontSize: "13px", fontWeight: "500", color: "#202223" }}>Form description</s-text>
                                                        <textarea
                                ...
                                <s-section>
                                    <s-stack gap="base">
                                        ...
                                        <s-stack direction="inline" gap="small" alignItems="center" style={{ marginTop: "8px" }}>
                                            ...
                                            <label htmlFor="auto-tag-field" style={{ fontSize: "13px", color: "#202223", cursor: "pointer" }}>{config.autoTagLabel}</label>
                                        </s-stack>
